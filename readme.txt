...
7. Training DCNN on UTKinect Action-3D Dataset
8. Training DCNN on CAD60 Dataset
9. Testing DCNN on UTKinect Action-3D Dataset
10.Testing DCNN on CAD60 Dataset
---------------------------------------------------------------------------------------
1. Downloading the Datasets
...
---------------------------------------------------------------------------------------
2. Creation of Color Skl-MHI and RJI Dataset on UTKinect Action-3D Dataset
For converting the 3D joint coordinate of URKinect Action-3D dataset, we need to download "Kin2" from this URL: https://github.com/jrterven/Kin2 and copy into the "tools" folder. Then, the creation of Color Skl-MHI and RJI Dataset on UTKinect Dataset can be done by running experiments\UTKinect\Create_ColorSklMHI_RJI_UTKinect.m file and the extracted Color Skl-MHI and RJI of UTKinect dataset will be stored in ColorSklMHI_RJI_UTKinect.mat which can be downloaded at: URL
---------------------------------------------------------------------------------------
3. Creating Color Skl-MHI and RJI Dataset on CAD60 Dataset
The creation of Color Skl-MHI and RJI Dataset on CAD60 Dataset can be done by running experiments\CAD60\Create_ColorSklMHI_RJI_CAD60.m file and the extracted Color Skl-MHI and RJI of CAD60 dataset will be stored in ColorSklMHI_RJI_CAD60.mat which can be downloaded at: URL
---------------------------------------------------------------------------------------
4. Separation of Training and Test Data
...
---------------------------------------------------------------------------------------
7. Training DCNN on UTKinect Dataset
After creating the hdf5 database of UTKinect Dataset, we can train DCNN for Color Skl-MHI and RJI data. We need to train 5 caffemodels for each person as follow:
a.	UTKinect_ColorSklMHI_NotP1
b.	UTKinect_RJI_1_NotP1
c.	UTKinect_RJI_2_NotP1
d.	UTKinect_RJI_3_NotP1
e.	UTKinect_RJI_4_NotP1
Therefore, the total trained models are 5 x 10 (people) = 50 caffemodels which can be downloaded at: URL
---------------------------------------------------------------------------------------
8. Training DCNN on CAD60 Dataset
After creating the hdf5 database of CAD60 dataset, we can train DCNN for Color Skl-MHI and RJI data. We need to train 5 caffemodels for each person as follow:
a.	CAD60_ColorSklMHI_NotP1
b.	CAD60_RJI_1_NotP1
c.	CAD60_RJI_2_NotP1
d.	CAD60_RJI_3_NotP1
e.	CAD60_RJI_4_NotP1
Therefore, the total trained models is 5 x 4 (people) = 20 caffemodels which can be downloaded at: URL
---------------------------------------------------------------------------------------
9. Testing DCNN on UTKinect Dataset
Trained DCNN on UTKinect Action-3D dataset can be tested by running the experiments\UTKinect\Test_DCNN_ColorSklMHI_RJI_UTKinect.m file. For calculating the overall accuracy, please change person id and caffemodels.
---------------------------------------------------------------------------------------
10.Testing DCNN on CAD60 Dataset
Trained DCNN on CAD60 dataset can be tested by running the experiments\CAD60\Test_DCNN_ColorSklMHI_RJI_CAD60.m file. For calculating the overall accuracy, please change person id and caffemodels.
---------------------------------------------------------------------------------------
